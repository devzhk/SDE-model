...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataname', type=str, default='25gm-train-v4-s50', help='name of the data file')
    ...
    gmm_model = Gmm_score(dim=args.dimension, mu=2.0, sigma2=1e-6, num_modes=4)
